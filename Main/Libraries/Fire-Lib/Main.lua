...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Thebestofhack123/PolleserHub/main/Main/Libraries/Fire-Lib/Library.lua"))()
...
if not t.EAGLE then
    ...
    local fhop = loadstring(game:HttpGet("https://raw.githubusercontent.com/Thebestofhack123/PolleserHub/main/Main/Libraries/Fire-Lib/PolleserHub%20Only%20page.lua"))()
